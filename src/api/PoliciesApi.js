...
import {StreamResultOfV1GetPolicyResponse} from '../model/StreamResultOfV1GetPolicyResponse';
...
const PoliciesApi = {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/StreamResultOfV1GetPolicyResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/StreamResultOfV1GetPolicyResponse}
     */
    searchPoliciesByFilter(policyResourceID, policyResourceType, policyActorID, policyActorType, policyPermissions, opts, callback) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = StreamResultOfV1GetPolicyResponse;
