...
// @ts-ignore
import type { V1RecordMetaProperties } from './v1-record-meta-properties';

/**
 * 
 * @export
 * @interface V1InsertRecordResponse
 */
export interface V1InsertRecordResponse {
    /**
     * Identifiers for the inserted records.
     * @type {Array<V1RecordMetaProperties>}
     * @memberof V1InsertRecordResponse
     */
    'records'?: Array<V1RecordMetaProperties>;
}
