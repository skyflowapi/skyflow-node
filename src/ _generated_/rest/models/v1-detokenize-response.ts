...
// @ts-ignore
import type { V1DetokenizeRecordResponse } from './v1-detokenize-record-response';

/**
 * 
 * @export
 * @interface V1DetokenizeResponse
 */
export interface V1DetokenizeResponse {
    /**
     * Records corresponding to the specified tokens.
     * @type {Array<V1DetokenizeRecordResponse>}
     * @memberof V1DetokenizeResponse
     */
    'records'?: Array<V1DetokenizeRecordResponse>;
}
