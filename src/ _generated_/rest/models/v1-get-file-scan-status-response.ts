...
// @ts-ignore
import type { V1FileAVScanStatus } from './v1-file-avscan-status';

/**
 * 
 * @export
 * @interface V1GetFileScanStatusResponse
 */
export interface V1GetFileScanStatusResponse {
    /**
     * 
     * @type {V1FileAVScanStatus}
     * @memberof V1GetFileScanStatusResponse
     */
    'av_scan_status'?: V1FileAVScanStatus;
}
