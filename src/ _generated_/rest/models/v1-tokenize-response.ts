...
// @ts-ignore
import type { V1TokenizeRecordResponse } from './v1-tokenize-record-response';

/**
 * 
 * @export
 * @interface V1TokenizeResponse
 */
export interface V1TokenizeResponse {
    /**
     * Tokens corresponding to the specified values.
     * @type {Array<V1TokenizeRecordResponse>}
     * @memberof V1TokenizeResponse
     */
    'records'?: Array<V1TokenizeRecordResponse>;
}
