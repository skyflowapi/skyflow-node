 ...
 * 
 * @export
 * @interface V1GetByTokenResponse
 */
export interface V1GetByTokenResponse {
    /**
     * Token of the returned record.
     * @type {string}
     * @memberof V1GetByTokenResponse
     */
    'token_id'?: string;
    /**
     * Record corresponding to the token.
     * @type {object}
     * @memberof V1GetByTokenResponse
     */
    'fields'?: object;
