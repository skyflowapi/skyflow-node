...
**Never edit files under `src/_generated_/`** — these are auto-generated by Fern and manual changes get overwritten on next generation. `VaultClient.initAPI()` selects the right generated client per operation type. If a bug is in generated code, report it rather than patching directly.
